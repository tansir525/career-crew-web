...
const WritingList = () => {
    ...
    return (
        <div className="container">
            ...
            <Link to="/dashboard/create/writing">
                <Button
                    variant="contained"
                    color="primary"
            ...
            <ModuleListTable tableDataList={writing} />
        </div>
    )
}
...
const CreateWriting = () => {
    ...
    const onSubmit = (data) => {
        ...
        return axios.post("http://127.0.0.1:8000/writingmodule/", formData
        ).then(function (response) {
            reset()
            swal("Success!", "Writing Module Created Successfully!", "success")
        })
...
export { CreateWriting, WritingList }
