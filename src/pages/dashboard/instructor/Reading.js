...
const ReadingList = () => {
    ...
    return (
        <div className="container">
            ...
            <Link to="/dashboard/create/reading">
                <Button
                    variant="contained"
                    color="primary"
            ...
            <ModuleListTable tableDataList={reading} />
        </div>
    )
}
...
const CreateReading = () => {
    ...
    const onSubmit = (data) => {
        ...
        return axios.post("http://127.0.0.1:8000/readingmodule/", formData
        ).then(function (response) {
            reset()
            swal("Success!", "Reading Module Created Successfully!", "success")
        })
...
export { CreateReading, ReadingList }
