...
const SpeakingList = () => {
    ...
    return (
        <div className="container">
            ...
            <Link to="/dashboard/create/speaking">
                <Button
                    variant="contained"
                    color="primary"
            ...
            <ModuleListTable tableDataList={speaking} />
        </div>
    )
}
...
const CreateSpeaking = () => {
    ...
    const onSubmit = (data) => {
        ...
        return axios.post("http://127.0.0.1:8000/speakingmodule/", formData
        ).then(function (response) {
            reset()
            swal("Success!", "Speaking Module Created Successfully!", "success")
        })
...
export { CreateSpeaking, SpeakingList }
