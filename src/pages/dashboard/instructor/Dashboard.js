...
const InstructorDashboard = () => {
    const [writing] = InstructorService.useGetWriting()
    const [reading] = InstructorService.useGetReading()
    const [speaking] = InstructorService.useGetSpeaking()
                    ...
                    <div className="PostSection">
                        <div className="PostSection--Grid">
                            <div className="PostCard">
                                <Link to="/dashboard/instructor/listening">
                            ...
                            <div className="PostCard">
                                <Link to="/dashboard/instructor/reading">
                                    <div className="PostCard--Image relative">
                            ...
                            <div className="PostCard">
                                <Link to="/dashboard/instructor/writing">
                                    <div className="PostCard--Image relative">
                            ...
                            <div className="PostCard">
                                <Link to="/dashboard/instructor/speaking">
                                    <div className="PostCard--Image relative">
                            ...
                            <div className="PostCard">
                                <Link to="/dashboard/instructor/livesession">
                                    <div className="PostCard--Image relative">
